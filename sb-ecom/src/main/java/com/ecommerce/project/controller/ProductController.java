...
public class ProductController {
    ...
    @GetMapping("/public/products/keyword/{productName}")
    public ResponseEntity<ProductResponse> getProductByName(
        ...
        ProductResponse productResponse = productService.getProductByName(productName,pageNumber,pageSize,sortBy,sortOrder);
